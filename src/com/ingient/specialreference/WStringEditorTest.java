 ...
 */
public class WStringEditorTest extends WEditor implements ContextMenuListener
{
     ...
     */
    public WStringEditorTest()
    {
    	this("String", false, false, true, 30, 30, "", null);
    }

    public WStringEditorTest(GridField gridField) {
    	this(gridField, false);
    }

    public WStringEditorTest(GridField gridField, boolean tableEditor)
    {
     ...
     * @param obscureType
     */
    public WStringEditorTest(String columnName, boolean mandatory, boolean isReadOnly, boolean isUpdateable,
			...
			dialog.addEventListener(DialogEvents.ON_WINDOW_CLOSE, new EventListener<Event>() {
				...
				public void onEvent(Event event) throws Exception {
					...
					if (!dialog.isCancelled()) {
				        ...
				        ValueChangeEvent changeEvent = new ValueChangeEvent(WStringEditorTest.this, WStringEditorTest.this.getColumnName(), oldValue, newText);
				        WStringEditorTest.super.fireValueChange(changeEvent);
				        oldValue = newText;
					}
				}
			});
